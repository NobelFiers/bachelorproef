...
%- Roll call in Canvas
%Voor het gebruik van deze methode wordt via het schoolplatform "Canvas" een QR-code aangemaakt. Deze code wordt geprojecteerd op een groot scherm zodat de studenten hem kunnen scannen. Elke student die de code scand % NOG SPELLCHECKEN 
%wordt automatisch via hun schoolplatform op aanwezig gezet \autocite{HARVARD}. Deze methode laat toe om grote hoeveelheden studenten tegelijk hun aanwezigheid te bevestigen. Volgens \textcite{HARVARD} is het nadeel van deze methode wel dat een werkende camera verplicht is alsook een stabiele internet connectie zodat de bevestiging van de QR-code degelijk wordt opgenomen in Canvas.


% bij hogent maken ze gebruik van
...
% DIT NOG VERANDEREN, NIET INSTANT VERMELDEN DAT GEOFENCING DE ENIGSTE OPTIE IS, BEGIN MET EEN OPLIJSTING VAN MOGELIJKHEDEN EN DAN MISCHIEN ZEGGEN "TOT SLOT, INDIEN MEN DICHTER WILT AANLEUNEN BIJ HET HUIDIG SYSTEEM VAN QR CODES, KAN ER GEKOZEN WORDEN OM DIT TE PROBEREN UITBREIDEN. DEZE UITBREIDING KAN OP (factchecken?) VERSCHILLENDE METHODES. -> geofencing eraan toevoegen.
...
\section{Biometrische data}  % commentaar ngeren van de pdf
...
\subsection{Geofencing}  % dit moet MEER ZIJN
